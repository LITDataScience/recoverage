...
- The shop fixture tests cover payments, pricing, and the cart branches. The checked-in sample is MRS 60, `needs-review`, statement coverage 100%. Typst is also found in the WinGet links directory when it is not on `PATH`.
